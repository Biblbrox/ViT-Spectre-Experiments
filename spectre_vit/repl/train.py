...
experiment_name = f"spectre_vit_mixing_{c.num_heads}h_hid{c.hidden_dim}_emb{c.embed_dim}_patch{c.patch_size}_enc{c.num_encoders}"
...
if not use_distillation:
    ...
    trainer = L.Trainer(accelerator="gpu", devices=1, logger=logger)
