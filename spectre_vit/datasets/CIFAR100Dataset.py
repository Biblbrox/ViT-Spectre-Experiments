...
class CIFAR100DataModule(DefaultDataset):
    def __init__(self, config):
        super().__init__(config)
        self.dataset_uri = "hf://datasets/uoft-cs/cifar100"
    ...
    def prepare_data(self):
        # download
        train_uri = "cifar100/train-00000-of-00001.parquet"
        val_uri = "cifar100/train-00000-of-00001.parquet"
        cache_dir = join(self.cache_dir, "cifar100")
